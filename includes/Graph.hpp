...
public:
	...
	;
	Graph(Node<T> *rootNode) :
			root_(rootNode) {
		//std::cout << "GRAPH CONSTRUCTED ROOT NODE: " << root_ << "\n\n";
	}
	;
	...
	//                       MUTATOR                        //
	//////////////////////////////////////////////////////////
	inline void SetRoot(Node<T> *node) {
		root_ = node;
	}
...
private:
	...
	//                       ACCESSOR                       //
	//////////////////////////////////////////////////////////
	void RecurveFindNodes(std::vector<Node<T>*> &foundNodes,
			Node<T> *currentNode);
	std::vector<Edge<T>*> GetEdges();
	inline Node<T>* GetRoot() {
		return root_;
	}
	//////////////////////////////////////////////////////////
	//                       ATTRIBUTES                     //
...
template<typename T>
void Graph<T>::RecurveFindNodes(std::vector<Node<T>*> &foundNodes,
		Node<T> *currentNode) {
